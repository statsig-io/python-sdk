...
class TestStatsigE2E(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.logs = {}
        options = StatsigOptions(api=cls.server.url, tier=StatsigEnvironmentTier.development)
    ...
    def test_z_logs(self):
        ...
        self.assertEqual(events[0]["user"].get("statsigEnvironment", None), {"tier": "development"})
        ...
        self.assertEqual(events[7]["metadata"]["item_name"], "diet_coke_48_pack")
