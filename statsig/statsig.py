...
def get_client_initialize_response(user: StatsigUser, client_sdk_key: Optional[str] = None, hash: Optional[HashingAlgorithm] = 'sha256', include_local_overrides: Optional[bool] = False) -> ClientInitializeResponse:
    """
